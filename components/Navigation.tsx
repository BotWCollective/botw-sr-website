  ...
  <nav className={styles.nav}>
    <div className={styles.nav_container}>
      <div className={styles.nav_container_logo}>
        <Link href="/">
          <a className={styles.nav_container_logo_link}>
            <img src={logo.src} alt="Fort Hateno" />
          </a>
        </Link>
      </div>
